...
<table width="515" border="0">
  <tr>
    ...
    <td width="393"><div align="left">
      <input type="text" name="solutionName" size="50" maxlength="50" value="{$dpToUpdate.pattern_solution_name}">
    </div></td>
  </tr>
  <tr>
    ...
    <td width="393"><div align="left">
      <select name="solutionObjective[]" size="4" multiple>
       {section name=i loop=$solutionObjective}
        <option value="{$solutionObjective[i].id}" {$solutionObjective[i].selected}>{$solutionObjective[i].objective}</option>
        {/section}
      </select>
    </div></td>
  </tr>
  <tr>
    ...
    <td><div align="left">
     <textarea  name="solutionIndicators" rows="4" cols="50">{$dpToUpdate.pattern_indicators}</textarea>
    </div></td>
  </tr>
  <tr>
    <td valign="top"><div align="right">M&eacute;thode(s) : </div></td>
    <td><div align="left">
     <textarea  name="solutionMethods" rows="4" cols="50">{$dpToUpdate.pattern_methods}</textarea>
    </div></td>
  </tr>
  <tr>
    <td valign="top"><div align="right">Description : </div></td>
    <td><div align="left">
      <textarea  name="solutionDesc" rows="4" cols="50">{$dpToUpdate.pattern_solution_desc}</textarea>
    </div></td>
  </tr>
  <tr>
    <td valign="top"><div align="right">Discussion : </div></td>
    <td><div align="left">
      <textarea  name="solutionDisc" rows="4" cols="50">{$dpToUpdate.pattern_solution_discussion}</textarea>
    </div></td>
  </tr>
  <tr>
