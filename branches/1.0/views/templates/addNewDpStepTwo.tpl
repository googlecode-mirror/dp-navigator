...
<table width="515" border="0">
  <tr>
    ...
    <td width="393"><div align="left">
      <textarea  name="dpProlem" rows="4" cols="50">{$dpProblem}</textarea>
    </div></td>
  </tr>
  <tr>
    ...
    <td><div align="left">
      <select name="trackingFocus[]" size="4" multiple>
       {section name=i loop=$trackingFocus}
        <option value="{$trackingFocus[i].id}">{$trackingFocus[i].focus}</option>
        {/section}
      </select>
    </div></td>
  </tr>
  <tr>
    ...
    <td><div align="left">
      <textarea  name="problemAnalysis" rows="4" cols="50">{$dpAnalysis}</textarea>
    </div></td>
  </tr>
