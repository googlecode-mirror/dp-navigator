...
<form id="formNewSituation" name="formNewSituation" method="post"  action="parameters.php?menu=situation&action=Save" onSubmit="return verifNewSituation()">
  Libell&eacute;
  <div><input name="nameNewSituation" value="" size="40" type="text">&nbsp;</div>
  <br/><br/>
