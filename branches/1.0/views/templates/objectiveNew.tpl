...
<form id="formNewObjective" name="formNewOjective" method="post"  action="parameters.php?menu=objective&action=Save" onSubmit="return verifNewObjective()">
  Libell&eacute;
  <div><input name="nameNewObjective" value="" size="40" type="text">&nbsp;</div>
  <br/><br/>
