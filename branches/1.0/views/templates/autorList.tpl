<table class="margebas" width="100%" border="0" cellspacing="0" cellpadding="0">
				  <tr>
					...
					<form id="formNewAutor" name="formNewAutor" method="post" action="parameters.php?menu=autor&action=New">
					&nbsp;&nbsp;<input id="btnNewAutor" name="btnNewAutor" type="submit" value=" Nouveau " class="buton2"/>
					</form>
					</td>
				...
				{section name=i loop=$autorList}
				<tr class="row2">
				 <td height="26" align="right" valign="middle">{$autorList[i].num}</td>
				 <td align="center" valign="middle"><input name="checkone" type="checkbox"></td>
				 <td align="left" valign="middle">{$autorList[i].name}</td>
				 <td align="left" valign="middle"><a href="parameters.php?menu=autor&action=Update&id={$autorList[i].id}"><img src="{$IMAGE_PATH}/icons/icon/write.png" title="Modifier" width="16" height="16" border="0"/></a>&nbsp;&nbsp;<a href="javascript: alert('Suppression indisponible !');"><img src="{$IMAGE_PATH}/icons/icon/delete.png" title="Supprimer" width="16" height="16" border="0"/></a></td>
				</tr>
				{/section}
				<tr>
