<table class="margebas" width="100%" border="0" cellspacing="0" cellpadding="0">
				  <tr>
					...
					<form id="formNewSystem" name="formNewSystem" method="post" action="parameters.php?menu=system&action=New">
					&nbsp;&nbsp;<input id="btnNewSystem" name="btnNewSystem" type="submit" value=" Nouveau " class="buton2"/>
					</form>
					</td>
