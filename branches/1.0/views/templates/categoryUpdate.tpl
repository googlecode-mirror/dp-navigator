...
<form id="formUpdateCategory" name="formUpdateCategory" method="post"  action="parameters.php?menu=category&action=Save" onSubmit="return verifUpdateCategory()">
  Libell&eacute;
  <div><input name="nameUpdateCategory" value="{$category.name}" size="40" type="text">
  </div>
  <br/><br/>
