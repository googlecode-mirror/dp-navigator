		...
		<div><img src="{$IMAGE_PATH}/security.jpg" style="float: left; padding-top:1.0em;" align="left" border="0"></div>
		 <div id="maincontent">
			...
			<div id="passforget">
			 ...
			 <p style="text-align:justify">Vous avez oubli&eacute; votre mot de passe, saisissez votre adresse email  et nous vous enverrons un courrier contenant votre mot de passe.</p>
	          <div align="left" class="style2" style="text-align: left; font-size: 9pt;">E.mail<br/><input id="forgetUserEmail" name="forgetUserEmail" type="text"/><br/>&nbsp;</div>
