		...
		<div><img src="{$IMAGE_PATH}/security.jpg" style="float: left; padding-top:1.0em;" align="left" border="0"></div>
		 <div id="maincontent">
			...
			<div id="passforget">
			 ...
			 <p style="text-align:justify">Un courriel vous a &eacute;t&eacute; envoy&eacute; &agrave; l'adresse suivante: <span class="redcolor">{$forgetUserEmail}</span>. <br>
			   Vos cordonn&eacute;es de connexion  y figure. Bonne reception ! </p>
	          <div align="left"></div>
			 </form>
