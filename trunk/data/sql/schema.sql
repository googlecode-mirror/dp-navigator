CREATE TABLE dp (id BIGINT AUTO_INCREMENT, name VARCHAR(255) NOT NULL UNIQUE, confidence VARCHAR(255), alias TEXT, synopsis TEXT, context TEXT, problem TEXT, problem_details TEXT, solution TEXT, solution_details TEXT, literature TEXT, notes TEXT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
